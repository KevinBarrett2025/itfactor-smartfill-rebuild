...
- `STSiPhone/STSiPhone/Features/SmartFill/Rebuild/SmartFillWorkspaceFollowUpRoute.swift` — authoritative follow-up routing seam for saved-result reopen behavior across project review/player, editor, and later standalone hidden-session flows
