...
- `STSiPhone/STSiPhone/Features/SmartFill/Rebuild/SmartFillReopenDestinationContext.swift` — authoritative saved-result destination-context seam for reopened player/review, editor, and later standalone hidden-session result views
